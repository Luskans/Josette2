...
export default function StoryCardMin({ story }) {
  return (
    <article className="w-60 h-52 flex flex-col bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      <div className="flex">
        <Link
          to={`/story/view/${story.id}`}
        ...
        <div className="flex flex-col gap-2 p-2">
          ...
          <div className="flex gap-2.5">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-300">
              {readingTime(story.content.length)}
            </p>
          </div>
          ...
          <div className="flex gap-2.5">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-300">5.2K</p>
          </div>
          ...
          <div className="flex gap-2.5">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-300">421</p>
          </div>
          ...
          <div className="flex gap-2.5">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-300">124K</p>
          </div>
        </div>
      </div>

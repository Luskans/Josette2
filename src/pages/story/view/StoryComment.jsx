  ...
  return (
    <>
      <div key={comment.id} className="flex items-start gap-2.5 mb-8">
                ...
                <>
                  ...
                  <li>
                    <button
                      type="button"
                      className="w-full py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      data-modal-target={`comment-delete-modal-${comment.id}`}
                      data-modal-toggle={`comment-delete-modal-${comment.id}`}
                    >
                      Supprimer
                    </button>
                  </li>
        ...
        <div
          id={`comment-delete-modal-${comment.id}`}
          tabIndex={-1}
          ...
          <div className="relative p-4 w-full max-w-md max-h-full">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              <button
                ...
                data-modal-hide={`comment-delete-modal-${comment.id}`}
              >
                <svg
                  className="w-3 h-3"
                  aria-hidden="true"

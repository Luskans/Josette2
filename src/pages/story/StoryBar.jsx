  ...
  return (
    <div className='flex justify-between py-4 px-3 mb-10 border-y dark:border-gray-400'>
      <div className='flex gap-5'>
        {user.imFollowing ? (
          <button className='flex gap-1.5' data-tooltip-target={`tooltip-likes${id}`}>
        ...
        <button onClick={onCommentIconClick} className='flex gap-1.5' data-tooltip-target={`tooltip-comments${id}`}>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-300">{story.comments ? story.comments.length : 0}</p>
        </button>
        <div

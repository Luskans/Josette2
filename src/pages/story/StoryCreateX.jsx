...
export default function StoryCreateX() {
  ...
  return (
    <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16"> 
            ...
            {step === 1 &&
                <StoryCreate1 handleNext={handleNext} /> 
            }

            {step === 2 &&
                <StoryCreate2 handlePrev={handlePrev} handleNext={handleNext} handleBlob={handleBlob} /> 
            }
            ...
            {step === 4 &&
                <StoryCreate4 handlePrev={handlePrev} blob={blob} /> 
            }

    ...
    <section className="bg-blue-700 dark:bg-blue-100 mt-16">
        <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-6 lg:px-6">
            ...
            <div className="mt-4 md:mt-0">
                ...
                <button className="inline-flex items-center text-gray-900 dark:text-white bg-blue-200 dark:bg-blue-700 hover:bg-blue-400 dark:hover:bg-blue-800 focus:ring-4 focus:ring-blue-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-blue-800">
                    Rejoindre

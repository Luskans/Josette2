...
export default function Footer() {
  return (
    ...
    // NEXTUI
    // <Navbar aria-label="Navigation" className='bg-blue-800 dark:bg-blue-100 py-3'>
    //   <NavbarContent justify="start">
    //     <NavbarItem className="hidden lg:flex">
    //       <img className='w-8 h-8 border' src='#' alt='' />
    //     </NavbarItem>
    //     <NavbarItem>
    //       <img className='w-8 h-8 border' src='#' alt='' />
    //     </NavbarItem>
    ...
    //     <NavbarItem>
    //       <Link color="foreground" href="#" className='text-white dark:text-gray-800'>
    //         About
    //       </Link>
    //     </NavbarItem>
    //     <NavbarItem>
    ...
    //     </NavbarItem>
    //   </NavbarContent>
    //   <NavbarContent justify="end" as={Link} href="/">
